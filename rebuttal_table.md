...
### Table D. Distribution mismatch (XENA and BSDS300) denoising results (PSNR/SSIM).

> **Bold** = best, _italic_ = second-best

| Train  | Test  | Noisy        | Dense        | SHIELD-P     | SHIELD-R     | SHIELD-PR     |
|--------|-------|-------------|-------------|-------------|-------------|--------------|
| XENA   | BSDS300| 20.52/0.422 | 16.83/0.827 | 16.88/0.815 | *17.12/0.837* | **18.09/0.840**  |
| BSDS300 | XENA  | 21.61/0.325 | 25.29/0.546 | 25.37/0.545 | *26.27/0.617* | **26.50/0.634**  |

#

### Table E. Analysis of self-supervised models in quantitative comparison (PSNR/SSIM) of denoising.
| Datasets   | Noisy        | AP-BSN       | AP-BSN (ES)                     | AP-BSN (ES+R, λ=0.5) | AP-BSN (ES+R, λ=0.01) | AP-BSN (ES+R, λ=0.001)            | PUCA         | PUCA (ES)                    | PUCA (ES+R, λ=0.1) | PUCA (ES+R, λ=0.01) | PUCA (ES+R, λ=0.001)              |
|------------|-------------|-------------|---------------------------------|----------------------|------------------------|-----------------------------------|--------------|-----------------------------|--------------------|----------------------|-----------------------------------|
| Tampere17  | 17.76/0.305 | 25.91/0.703 | 25.96(+0.05)/**0.702**(-0.001) | 22.08/0.545          | 25.58/0.681            | 26.02(+0.11)/*0.701*(-0.002)      | 26.03/0.684  | *26.14*(+0.11)/0.684(+0.000) | 21.91/0.573        | 25.42/0.661          | **26.25**(+0.22)/0.687(+0.003)    |
| Kodak24    | 17.36/0.263 | 25.16/0.692 | 25.18(+0.02)/0.691(-0.001)     | 21.82/0.541          | 25.25/0.674            | *25.63*(+0.47)/**0.695**(+0.003)  | 25.49/0.675  | 25.61(+0.12)/*0.676*(+0.001) | 21.58/0.554        | 24.66/0.630          | **25.66**(+0.17)/0.670(-0.005)    |
| Set14      | 15.21/0.201 | 22.67/0.644 | *22.68*(+0.01)/*0.643*(-0.001) | 18.63/0.414          | 22.42/0.613            | **22.98**(+0.31)/**0.648**(+0.004)| 22.13/0.602  | 22.18(+0.05)/0.602(+0.000)   | 18.43/0.460        | 21.45/0.565          | 22.10(-0.03)/0.602(+0.000)        |
#
